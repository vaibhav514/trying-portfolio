        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              My field of Interest's are building and learning about new &nbsp;
              <i>
                <b className="purple">Technologies and Products </b> and
                my Interest are also in reading novels related to{" "}
                <b className="purple">
                  Sci-Fi and Fantasy.
                </b>
              </i>
              ...
              &nbsp; like
              <i>
                <b className="purple"> INSTAGRAM </b>
              </i>
            </p>
          </Col>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/vaibhav514"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/vaibhav6296002"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/vaibhav-agrawal-329052196/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/_.vaibhav.06._"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
